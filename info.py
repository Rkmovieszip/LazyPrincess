...
API_ID = int(environ['API_ID' '21527086'])
API_HASH = environ['API_HASH' '11caabfc20fca699feff0c24213b1a80']
BOT_TOKEN = environ['BOT_TOKEN']

# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 300))
USE_CAPTION_FILTER = bool(environ.get('USE_CAPTION_FILTER', False))
PICS = (environ.get('PICS', 'https://telegra.ph/file/c213860d5a4f89a87b84d.jpg')).split()
PRIME_LOGO = (environ.get('PRIME_LOGO', 'https://telegra.ph/file/c213860d5a4f89a87b84d.jpg'))
...
# MongoDB information *
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Lootere:Lootere@cluster0.cneez.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
REQ_CHANNEL = int(environ.get('REQ_CHANNEL' '1002177424257'))
PRIME_MEMBERS_LOGS = int(environ.get('PRIME_MEMBERS_LOGS' '1798348973'))
# PREMIUM ACCESS *
...
UPI_ID = environ.get('UPI_ID', 'looterakrish@ybl') #enter your upi id here - grab it from your online payment methods.

# Others
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/rkmovieszip') # Tutorial video link for opening shortlink website 
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'rkmovieszip')
P_TTI_SHOW_OFF = is_enabled((environ.get('P_TTI_SHOW_OFF', "False")), False)
IMDB = is_enabled((environ.get('IMDB', "True")), True)
SINGLE_BUTTON = is_enabled((environ.get('SINGLE_BUTTON', "True")), False)
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "⚡<b>File uploaded by [Movies Adda™](https://t.me/rkmoviezip)</b>⚡\n\n📂<b>File Name:</b> ⪧ {file_caption} \n <b>Size: </b>{file_size}\n\n❤")
...
ADMIN_USRNM = environ.get('ADMIN_USRNM','krish_rule') # WITHOUT @
MAIN_CHANNEL_USRNM = environ.get('MAIN_CHANNEL_USRNM','rkmoviesmain') # WITHOUT @
DEV_CHANNEL_USRNM = environ.get('DEV_CHANNEL_USRNM','Rkmoviezip') # WITHOUT @
LAZY_YT_HANDLE = environ.get('LAZY_YT_HANDLE','rkmoviesmain')  # WITHOUT @ [  add only handle - don't add full url  ] 
MOVIE_GROUP_USERNAME = environ.get('MOVIE_GROUP_USERNAME', "rkmovieszip") #[ without @ ]
...
my_users = [int(my_users) if id_pattern.search(my_users) else my_users for my_users in environ.get('MY_USERS', '1798348973').split()]
...
OWNER_USERNAME = "Krish_rule"

lazydownloaders = [int(RKdownloaders) if id_pattern.search(RKdownloaders) else lazydownloaders for lazydownloaders in environ.get('PRIME_DOWNLOADERS', '1798348973').split()]
PRIME_DOWNLOADERS = (RKdownloaders) if lazydownloaders else []
...
DISCUSSION_CHAT_USRNM = "rkmovieszip" #without @

# Download Tutorial Button #
DOWNLOAD_TEXT_NAME = "📥 HOW TO DOWNLOAD 📥"
DOWNLOAD_TEXT_URL = "https://t.me/rkmovieszip"

# Custom Caption Under Button #
CAPTION_BUTTON = "Get Updates"
CAPTION_BUTTON_URL = "https://t.me/rkmoviezip"
